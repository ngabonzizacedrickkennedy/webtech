...
public class DataSeederController {
                ...
                for (int day = 0; day < 7; day++) {
                    ...
                    for (int timeIndex = 0; timeIndex < times.length; timeIndex++) {
                        ...
                        try {
                            ...
                            screening.setFormat(screenNumber % 2 == 0 ?
                            ...
                            screening.setBasePrice(basePrice); // FIXED: Changed from setPrice to setBasePrice
                            ...
                            screening.setEndTime(endDateTime);

                            screeningService.createScreening(screening);
                            count++;
                        } catch (Exception e) {
                            // Skip if a similar screening already exists or there's a conflict
                        }
                    }
                }
            }
    ...
    /**
     * Helper method to create a MovieDTO with genre name
     */
    private MovieDTO createMovie(String title, String description, int durationMinutes, String genreName,
    ...
    private List<TheatreDTO> getDefaultTheatres() {
        return Arrays.asList(
                ...
                createTheatre(
                        "Grand Theatre Midtown",
                        "789 Park Boulevard, Midtown, NYC 10018",
                        "+1 (212) 555-9012",
                        "info@grandtheatre.com",
                        "A historic cinema lovingly restored to its former glory. Featuring classic architecture with modern amenities including 4K digital projection and Dolby Atmos sound.",
                        10,
                        "https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80"
                )
        );
    }
     ...
     */
    private TheatreDTO createTheatre(String name, String address, String phoneNumber, String email,
                                     String description, int totalScreens, String imageUrl) {
